#!/usr/bin/env python3
"""
Crypto Price Monitor Runner

This script runs the crypto price monitor from the project root directory.
It handles virtual environment activation and proper path setup.
"""
...
def main():
    """Main entry point for the crypto price monitor."""
    
    # Get the project structure
    current_dir = Path(__file__).parent
    project_root = current_dir.parent.parent
    venv_path = current_dir / 'venv'
    monitor_script = current_dir / 'src' / 'price_monitor.py'
    ...
    try:
        print(f"Starting crypto price monitor from {project_root}")
