"""
CoinGlass Index Fear & Greed History API Tool

This module provides functionality to fetch crypto fear & greed index history data
...
Usage Example:
    from tools.coinglass.index_fear_greed_history import get_index_fear_greed_history
    
    # Get fear & greed index history
    data = get_index_fear_greed_history()
"""
...
def get_index_fear_greed_history(interval="1d", start_time=None, end_time=None):
    """
    Fetch crypto fear & greed index history from CoinGlass API.
    ...
    Returns:
        list or pandas.DataFrame: List of dictionaries or DataFrame containing fear & greed index data
    ...
    Example:
        data = get_index_fear_greed_history("1d")
        print(data[:5])  # Show first 5 fear & greed index records
    """
    # Validate API key
...
if __name__ == "__main__":
    ...
    # It fetches crypto fear & greed index history from CoinGlass API.
    # Example usage:
    #   python index_fear_greed_history.py --interval 1d
    #   python index_fear_greed_history.py --interval 1h --output_format csv
    import argparse
    import json
    
    parser = argparse.ArgumentParser(description="Fetch crypto fear & greed index history from CoinGlass API")
    parser.add_argument('--interval', type=str, default='1d', help='Time interval (default: 1d)')
