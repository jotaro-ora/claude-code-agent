"""
CoinGlass Spot Supported Exchange Pairs API Tool

This module provides functionality to fetch supported spot exchanges and pairs
...
Usage Example:
    from tools.coinglass.spot_supported_exchange_pairs import get_spot_supported_exchange_pairs
    
    # Get all supported spot exchange pairs
    data = get_spot_supported_exchange_pairs()
"""
...
def get_spot_supported_exchange_pairs():
    """
    Fetch the list of supported spot exchanges and pairs from CoinGlass API.
    ...
    Example:
        data = get_spot_supported_exchange_pairs()
        print(list(data.keys())[:5])  # Show first 5 exchanges
    """
    # Validate API key
...
if __name__ == "__main__":
    ...
    # It fetches the list of supported spot exchanges and pairs from CoinGlass API.
    # Example usage:
    #   python spot_supported_exchange_pairs.py
    #   python spot_supported_exchange_pairs.py --output_format json
    import argparse
    import json
    
    parser = argparse.ArgumentParser(description="Fetch the list of supported spot exchanges and pairs from CoinGlass API")
