"""
CoinGlass Spot Supported Coins API Tool

This module provides functionality to fetch the list of supported spot coins 
...
Usage Example:
    from tools.coinglass.spot_supported_coins import get_spot_supported_coins
    
    # Get all supported spot coins
    data = get_spot_supported_coins()
"""
...
def get_spot_supported_coins():
    """
    Fetch the list of supported spot coins from CoinGlass API.
    
    Returns:
        list or pandas.DataFrame: List of dictionaries or DataFrame containing supported spot coins data
    ...
    Example:
        data = get_spot_supported_coins()
        print(data[:5])  # Show first 5 supported spot coins
    """
    # Validate API key
...
if __name__ == "__main__":
    ...
    # It fetches the list of supported spot coins from CoinGlass API.
    # Example usage:
    #   python spot_supported_coins.py
    #   python spot_supported_coins.py --output_format csv
    import argparse
    import json
    
    parser = argparse.ArgumentParser(description="Fetch the list of supported spot coins from CoinGlass API")
