"""
CoinGlass Futures Supported Coins API Tool

This module provides functionality to fetch the list of supported futures coins 
...
Usage Example:
    ...
    # Get all supported futures coins
    df = get_futures_supported_coins()
"""
...
def get_futures_supported_coins():
    """
    Fetch the list of supported futures coins from CoinGlass API.
    
    Returns:
        list or pandas.DataFrame: List of dictionaries or DataFrame containing supported futures coins data
...
if __name__ == "__main__":
    ...
    # It fetches the list of supported futures coins from CoinGlass API.
    # Example usage:
    #   python futures_supported_coins.py
    #   python futures_supported_coins.py --output_format csv
    import argparse
    import json
    
    parser = argparse.ArgumentParser(description="Fetch the list of supported futures coins from CoinGlass API")
    ...
    try:
        ...
        data = get_futures_supported_coins()
