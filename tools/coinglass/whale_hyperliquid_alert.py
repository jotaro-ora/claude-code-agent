"""
CoinGlass Whale Hyperliquid Alert API Tool

This module provides functionality to fetch Hyperliquid whale alert data
...
Usage Example:
    from tools.coinglass.whale_hyperliquid_alert import get_whale_hyperliquid_alert
    
    # Get Hyperliquid whale alerts
    data = get_whale_hyperliquid_alert()
"""
...
def get_whale_hyperliquid_alert(limit=100):
    """
    Fetch Hyperliquid whale alerts from CoinGlass API.
    
    Args:
        limit (int): Number of records to return (default: 100)
    
    Returns:
        list or pandas.DataFrame: List of dictionaries or DataFrame containing whale alert data
    ...
    Example:
        data = get_whale_hyperliquid_alert(50)
        print(data[:5])  # Show first 5 whale alert records
    """
    # Validate API key
...
if __name__ == "__main__":
    ...
    # It fetches Hyperliquid whale alerts from CoinGlass API.
    # Example usage:
    #   python whale_hyperliquid_alert.py --limit 50
    #   python whale_hyperliquid_alert.py --limit 100 --output_format csv
    import argparse
    import json
    
    parser = argparse.ArgumentParser(description="Fetch Hyperliquid whale alerts from CoinGlass API")
    ...
    try:
        ...
        data = get_whale_hyperliquid_alert(limit=args.limit)
