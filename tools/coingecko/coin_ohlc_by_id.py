...
if __name__ == "__main__":
    ...
    # It parses command-line arguments and calls get_coin_ohlc_by_id with those arguments.
    # Example usage:
    #   python coin_ohlc_by_id.py --coin_id bitcoin --days 30
    #   python coin_ohlc_by_id.py --coin_id ethereum --vs_currency usd --days 7
    parser = argparse.ArgumentParser(description="Fetch OHLC chart data for a specific coin from CoinGecko API.")
